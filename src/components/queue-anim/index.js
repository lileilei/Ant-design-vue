...
var QueueAnim = function (_React$Component) {
  ...
  QueueAnim.prototype.componentDidMount = function componentDidMount() {
    (0, _warning2["default"])(false, '`QueueAnim` is deprecated, ' + 'you can import QueueAnim from \'rc-queue-anim\' directly.' + 'The demos will be moved to http://motion.ant.design/#/component/queue-anim');
  };
